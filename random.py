...
@_coconut_tco
def dice_rolls():
    return _coconut_tail_call(_coconut.itertools.chain.from_iterable, (_coconut_func() for _coconut_func in (lambda: (random.randint(1, 6),), lambda: dice_rolls())))

(print)(_coconut_igetitem(dice_rolls(), 0))

(print)((list)(_coconut_igetitem(dice_rolls(), _coconut.slice(0, 4))))

(print)((list)((sorted)(_coconut_igetitem(dice_rolls(), _coconut.slice(0, 4)))))

(print)(((sorted)(_coconut_igetitem(dice_rolls(), _coconut.slice(0, 4))))[_coconut.slice(1, None)])
